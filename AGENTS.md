...
- **Dual-Engine Synthetic Regression Suite (`test_synthetic_harness.py`)**: **58/58 PASS** across both C++ and Python engines covering 29 distinct edge cases (Tests 1–29).
...
- **Unit Tests**: `pytest test_nt_sniff.py` 24/24 PASS.
