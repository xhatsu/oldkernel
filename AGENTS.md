...
- **Dual-Engine Synthetic Regression Suite (`test_synthetic_harness.py`)**: **54/54 PASS** across both C++ and Python engines covering 27 distinct edge cases (Tests 1–27).
...
- **Unit Tests**: `pytest test_nt_sniff.py` 22/22 PASS.
